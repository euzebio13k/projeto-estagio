    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="/si/index.php" class="nav-link px-2 text-secondary">Home</a></li>
          <li><a href="/si/aluno/listar.php" class="nav-link px-2 text-white">Lista de Alunos</a></li>
          <li><a href="/si/vaga/listar.php" class="nav-link px-2 text-white">Vagas de Estagio</a></li>
